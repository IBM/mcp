...
| Server name | Description | Usage |
|---|---|---|
| [IBM Security Verify MCP Server](https://github.com/IBM/verify-mcp-server) | Access 210 IBM Security Verify REST API endpoints through 4 intelligent MCP tools — discover endpoints, list categories, get API details, and execute any Verify endpoint. | *[see link for instructions](https://github.com/IBM/verify-mcp-server)* |
