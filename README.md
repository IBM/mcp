...
- [IBM Decision Intelligence MCP Server](https://github.com/DecisionsDev/decision-intelligence-mcp-server) - This MCP server provides tools to invoke decision services deployed by [IBM Decision Intelligence](https://www.ibm.com/docs/en/decision-intelligence) or [IBM Automation Decision Services](https://www.ibm.com/fr-fr/products/automation-decision-services)
