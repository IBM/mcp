...
| [IBM i MCP server](https://ibm.biz/ibmi-mcp) | Build MCP tools around your enerprise data on IBM i or query the system for important operational and security information. Runs local or remote. | *see link for instructions* |
